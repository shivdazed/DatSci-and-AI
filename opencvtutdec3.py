...
iadw1 = cv2.imread('/Users/purnimagebhardt/Downloads/untitled folder/anuroopcvpic.jpeg')

cv2.rectangle(iadw1,(0,0),(318,159),(155,0,50),5)
cv2.putText(iadw1,'Friends',(0,40),cv2.FONT_ITALIC,2,(255,0,0),4)
cv2.imshow('IMAGE WINDOW',iadw1);
a= cv2.waitKey(0)
if a == ord('q'):
    cv2.destroyAllWindows()

face_img1 = cv2.imread('')
face_img = cv2.imread('ff2  ',0)
"""
import cv2
